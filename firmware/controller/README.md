# HnR'26 hardware badge: NFC controller firmware source files

This directory contains the CircuitPython 10 firmware source files for the
Hack&Roll 2026 hardware badge NFC controller.

## License

The firmware source files in this directory are open-sourced, licensed under
MIT. See [LICENSE.md](./LICENSE.md) for the full license text.

## Acknowledgements

This Hack&Roll 2026 hardware badge would not have been possible without the
following people:
